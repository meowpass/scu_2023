...
if os.path.exists("/mnt/localdata/Users/junlongli/projects/datasets/icdar2019"):
    ...
    PATH = "/mnt/datasets/datasets/icdar2019/trackA_modern/test"
...
class eval:
    ...
    # reg_gt_path = os.path.abspath("datasets/test")
    # reg_gt_path_archival = os.path.abspath("datasets/test")
    # reg_gt_path_modern = os.path.abspath("datasets/test")
    # str_gt_path_1 = os.path.abspath("datasets/test")
    # str_gt_path_2 = os.path.abspath("datasets/test")
    # str_gt_path_archival = os.path.abspath("datasets/test")
    # str_gt_path_modern = os.path.abspath("datasets/test")
