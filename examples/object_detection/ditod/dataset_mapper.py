...
class DetrDatasetMapper:
    ...
    def __call__(self, dataset_dict):
        ...
        # but not efficient on large generic datasets structures due to the use of pickle & mp.Queue.
        ...
        if "annotations" in dataset_dict:
            ...
            # USER: Implement additional transformations if you have other types of datasets
            annos = [
