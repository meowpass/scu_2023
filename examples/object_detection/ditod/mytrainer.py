...
class MyTrainer(TrainerBase):
    ...
    def build_hooks(self):
        ...
        ret = [
            ...
            hooks.PreciseBN(
                ...
                self.model,
                # Build a new datasets loader to not affect training
    ...
    def build_test_loader(cls, cfg, dataset_name):
        ...
        It now calls :func:`detectron2.datasets.build_detection_test_loader`.
        Overwrite it if you'd like a different datasets loader.
        """
        if cfg.AUG.DETR:
