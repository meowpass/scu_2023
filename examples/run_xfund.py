...
class DataTrainingArguments:
    ...
    train_file: Optional[str] = field(
        default=None, metadata={"help": "The input training datasets file (a csv or JSON file)."}
    )
    validation_file: Optional[str] = field(
        default=None,
        metadata={"help": "An optional input evaluation datasets file to evaluate on (a csv or JSON file)."},
    )
    test_file: Optional[str] = field(
        default=None,
        metadata={"help": "An optional input test datasets file to predict on (a csv or JSON file)."},
    )
